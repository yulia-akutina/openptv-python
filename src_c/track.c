...
int trackcorr_c_loop (int step, double lmax, double Ymin, double Ymax, int display )
  /* sequence loop */
...
foundpix *w, *wn, p16[16];
      ...
      for (h=0; h<m[1]; h++)
	{
	  ...
	  /*
	    ...
	    drawvector ( intx0, inty0, intx1, inty1, 1, j, "white");
	    drawvector ( intx1, inty1, intx2, inty2, 1, j, "white");
	    drawvector ( intx3, inty3, intx2, inty2, 1, j, "white");
	    drawvector ( intx0, inty0, intx3, inty3, 1, j, "white");
	    }
	  */
...
/*			drawcross(intx0,inty0,cr_sz,j,"green");*/
/*			drawcross(intx1,inty1,cr_sz+1,j,"yellow");*/
/*			drawcross(intx2,inty2,cr_sz+1,j,"white");*/
/*			drawvector ( intx0, inty0, intx1, inty1, 2, j, buf);*/
/*			drawvector ( intx1, inty1, intx2, inty2, 1, j, "white");*/
...
/*			  draw_pnr (  intx0, inty0, h, j, "white");*/
/*			  draw_pnr (  intx0, inty0+10, mega[1][h].next, j, val);*/
/*			  draw_value ( intx0, inty0 + 20,mega[1][h].finaldecis, j, val);*/
				 }
